...
<link href="css/testm.css" rel="stylesheet">	
				  ...
				  <!--<select class="sel">-->
					  <!--<option class="op">-->
					   <ul class="sel dropdown-menu">
					    ...
					    <a href="#"><li class="ui"><img src="images/flag-1.png" width="16px" height="14">
					    <span class="active">English</span></li></a>
					   
					  <!--</option>-->
				
					  
					     <a href="#"><li class="ui"><img src="images/flag5.png" width="16px" height="14">
							 <span>Arabic</span></li></a>
					  
					  
					  
					  
					    <a href="#"><li class="ui"><img src="images/flag6.png" width="16px" height="14">
					    <span>French</span></li></a>
					  
					  
					  
						<a href="#"><li><img src="images/flag7.png" width="16px" height="14">
            ...
            <div class="row justify-content-center">
                <div class="col-10">
                    <div class="testimonial-slides owl-carousel">
                        ...
                        <div class="single-testimonial-slide" style="margin-top: 60px">
                            <img src="images/quote.png" alt="">
                            <p>BlueFresh is so simple, it's so easy to use. And from the customer's standpoint it's <br>very intuitive, the platform is pretty much unlimited features!</p>
                            <div class="ratings-name d-flex align-items-center justify-content-center">
                                ...
                                <h5 style="margin-top: 10px">Jackson Nash</h5>
                            </div>
                        </div>
			...
			<div class="agile_ab_w3ls_info">
				<div class="col-md-6 ab_pic_w3ls">
				 ...
				 <div class="col-md-6 ab_pic_w3ls_text_info">
				    <h5>About Our Hatly <span> Shoppy</span> </h5>
