			...
			<div class="cart box_1">
						<a href="checkout_2.php">
							<h3> <div class="total">
								...
								<span>0.00</span> (<span id="simpleCart_quantity">0</span> items)</div>
...
<!-- //Modal2 -->
	...
	$sql = "DELETE FROM checkout where client_id = '$id'";
						...
						<?php
						         ...
						         /*$total = 0;
		                               ...
		                               include('C:/xampp/htdocs/hatly/Connection/connection.php');		
		                                 ...
		                                 $sql = $con->prepare("SELECT * FROM product WHERE client_id = '$id'");
                                         $sql->execute();
                                         $rows = $sql->fetchAll();
						   ...
						   echo  '<li class="totals">Total <i>-</i> <span>' . "0.00" . '</span></li>';
