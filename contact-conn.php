...
$sql=$con->prepare("SELECT * FROM deliverer WHERE 
 email=? AND first_name=? AND address=?");
$sql->execute(array($email , $name , $address));
$row=$sql->fetch();
$count=$sql->rowCount();
...
if($count>0){
    ...
    foreach($rows as $pat)
    {
        if($email == $pat["email"] && $address == $pat["address"] && $name == $pat["first_name"])
        {
            
			
			//session_start();
			
			$_SESSION["servant"] = $pat['servant_id'];
			$_SESSION["id"] = $pat['id'];
			...
			$sql = "INSERT INTO customer_service (name , gmail , address , subject , message , servant_id , deliverer_id) VALUES ('$name', '$email', '$address', '$subject', '$message' , '$e' , '$q')";
				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav menu__list">
					...
					<li class="dropdown menu__item">
						<a href="#" class="dropdown-toggle menu__link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">men wears <span class="caret"></span></a>
					...
					<li class="dropdown menu__item">
						<a href="#" class="dropdown-toggle menu__link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">women wears <span class="caret"></span></a>
							<ul class="dropdown-menu multi-column columns-3">
								<div class="row">
									<div class="col-sm-3 multi-gd-img">
										<ul class="multi-column-dropdown">
					...
					<div class="modal-header">
						...
						<h3 class="agileinfo_sign">Sign In <span>Now</span></h3>
						  ...
						  <ul class="social-nav model-3d-0 footer-social w3_agile_social top_agile_third">
														...
														<div class="clearfix"></div>
														<p><a href="#" data-toggle="modal" data-target="#myModal2" > Do not have an account?</a></p>
...
<!-- contact -->
	<div class="contact">
	  ...
	  <div class="alert alert-success dd" role="alert">
	  
			<strong>Well done!</strong> Your Message are sent successfully. Waiting 24 hours for answering.
			...
			<form method="post" action="contact-conn.php" enctype="multipart/form-data">
				<div class="contact-form2">
					...
					<input type="text" style="margin-top:20px; width: 100%" name="subject"  placeholder="Subject"  required="">
					<input type="text" style="margin-top:20px; width: 100%" name="address" placeholder="Address"  required="">
			...
			<div class="sign-grds">
				<div class="col-md-4 sign-gd">
					...
					<ul>
						...
						<li><a href="mens.php">Men Wears</a></li>
						<li><a href="womens.php">Women Wears</a></li>
								...
								<div class="login">
									<div class="login-bottom">
										...
										<form>
											<div class="sign-up">
												<h4>Email :</h4>
												<input type="text" value="Type here"  required="">	
											</div>
											<div class="sign-up">
												<h4>Password :</h4>
...
if($count>0){
    ...
    foreach($rows as $pat)
    {
        if($email == $pat["email"] && $address == $pat["address"] && $name == $pat["first_name"])
        {
			...
			$sql = "INSERT INTO customer_service (name , gmail , address , subject , message , servant_id , client_id) VALUES ('$name', '$email', '$address', '$subject', '$message' , '$a' , '$v')";
...
<!-- contact -->
	<div class="contact">
	  ...
	  <div class="alert alert-danger dd" role="alert">
	   
			<strong>Oh Error!</strong> That email or name or address is incorrect. Please enter a valid email or address or name.
			<button type="button" class="close" data-dismiss="alert" aria-label="Close">
            <span aria-hidden="true">&times;</span>
            </button>
