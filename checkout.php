...
<!-- //header-bot -->	
	...
	$sql = "INSERT INTO checkout (name , image , price , client_id) VALUES ('$name', '$image' , '$price' , '$id')";
...
<!-- //Modal2 -->
	...
	$sql = "UPDATE product SET client_id ='$id'  WHERE id = '$opp'";
				  ...
				  //if($pat["id"] == $opp){
					...
					echo '<tr class="rem1">
						<td class="invert-closeb">
						    ...
						    <a href="delete_product.php?id=',$pat['id'],'">
						...
						<td class="invert-image"><a href="single.php"><!--<img src="images/w4.png" alt=" " class="img-responsive" />--><img data-imagezoom="true" class="img-responsive" src="data:image;base64,' . $pat["image"]  . '"></a></td>
						<td class="invert">
							 <div class="quantity"> 
						...
						<td class="invert">' . $pat["name"] . '</td>
						<td class="invert">$' . $pat["price"] . '</td>
					</tr>';
				 //}
	}
	?>
					<!--<tr class="rem2">
						...
						<td class="invert-image"><a href="single.php"><img src="images/ep3.png" alt=" " class="img-responsive" /></a></td>
						<td class="invert">
							 <div class="quantity"> 
								<div class="quantity-select">                           
									<div class="entry value-minus">&nbsp;</div>
					...
					<tr class="rem3">
						...
						<td class="invert-image"><a href="single.php"><img src="images/w2.png" alt=" " class="img-responsive" /></a></td>
						<td class="invert">
							 <div class="quantity"> 
								<div class="quantity-select">                           
									<div class="entry value-minus">&nbsp;</div>
					...
					<tr class="rem4">
						...
						<td class="invert-image"><a href="single.php"><img src="images/w1.png" alt=" " class="img-responsive" /></a></td>
						<td class="invert">
							 <div class="quantity"> 
								<div class="quantity-select">                           
									<div class="entry value-minus">&nbsp;</div>
		...
		<div class="checkout-left">	
				...
				<div class="col-md-4 checkout-right-basket animated wow slideInRight" data-wow-delay=".5s">
					<a href="mens.php"><span class="glyphicon glyphicon-menu-left" aria-hidden="true"></span>Back To Shopping</a>
				</div>
			    <div class="col-md-5 checkout-right-basket animated wow slideInRight lef" data-wow-delay=".5s">
					<a href="payment.php"><span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span>Go To Payment</a>
				</div>
				<div class="checkout-left-basket animated wow slideInLeft" data-wow-delay=".5s">
					...
					<ul>
						...
						<?php
						         ...
						         $total = 0;
		                               ...
		                               include('C:/xampp/htdocs/hatly/Connection/connection.php');		
                                         ...
                                         foreach($rows as $pat)
										 {
						                    ...
						                    echo '<li>' . $pat["name"] . '<i>-</i> <span>$' . $pat["price"] . '</span></li>';
						   ...
						   echo  '<li class="totals">Total <i>-</i> <span>$' .  $total . ".00" . '</span></li>';
