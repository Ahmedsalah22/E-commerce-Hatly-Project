			  ...
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav menu__list">
					...
					<li class=" menu__item"><a class="menu__link" href="furniture.php">Furnitures</a></li>-->
					<li class="dropdown menu__item">
...
<!-- Start Payment Methods -->
		<!--<div class="row roww text-center">
					<div class="col-md-12 col-md-offset-1">
						<div class="process-wrap">
							<div class="col-md-4 process text-center active">
								<p class="po"><span>01</span></p>
								<h3>Shopping Cart</h3>
							</div>
							<div class="boxx text-center"><i class="fa fa-chevron-right"></i></div>
							<div class="col-md-4 process text-center active">
								<p class="po"><span>02</span></p>
								<h3>Payment</h3>
							</div>
							<div class="boxx text-center"><i class="fa fa-chevron-right"></i></div>
							<div class="col-md-4 process text-center">
								<p class="pi"><span>03</span></p>
								<h3>Order Complete</h3>
							</div>
							<!--<div class="col-md-2 boxx text-center"><i class="fa fa-chevron-right"></i><!-</div>
							<div class="col-md-2 proces text-center active">
							   <h3 class="yu">End</h3>
							</div>
						</div>
					</div>
				</div>-->
	<div class="col-md-10 col-md-offset-1 roww text-center">
						<div class="process-wrap">
							<div class="col-md-3 process text-center active">
								<p><span>01</span></p>
								<h3>Shopping Cart</h3>
							</div>
							<div class="boxx text-center"><i class="fa fa-chevron-right"></i></div>
							...
							<div class="boxx text-center"><i class="fa fa-chevron-right"></i></div>
							<div class="col-md-3 process text-center">
								<p><span>03</span></p>
								<h3>Order Complete</h3>
							</div>
						</div>
	...
	<div class="page-area cart-page spad payments">
		<div class="container">
					...
					<div class="col-lg-6">
						...
						<div class="row tabs">
							...
							<div class="col-md-12">
								...
								<input type="text" placeholder="Paypal Number *">
						...
						<!-- Tab Two -->
							...
							<div class="col-md-12">
								...
								<div class="checkbox-items1">
									<div class="ci-item1">
										<input type="checkbox" name="a" id="tand">
										<label for="tand">Terms and conditions</label>
									</div>
									<div class="ci-item1">
										<input type="checkbox" name="b" id="newaccoun">
										<label for="newaccoun">Create an account</label>
										<input type="password" placeholder="password">
									</div>
									<div class="ci-item1">
										<input type="checkbox" name="c" id="newslette">
										<label for="newslette">Subscribe to our newsletter</label>
									</div>
								</div>
							</div>
						</div>
						...
						<!-- Tab Three -->
							...
							<div class="col-md-12">
								...
								<div class="checkbox-items2">
									<div class="ci-item2">
										<input type="checkbox" name="a" id="tan">
										<label for="tan">Terms and conditions</label>
									</div>
									<div class="ci-item2">
										<input type="checkbox" name="b" id="newaccou">
										<label for="newaccou">Create an account</label>
										<input type="password" placeholder="password">
									</div>
									<div class="ci-item2">
										<input type="checkbox" name="c" id="newslett">
										<label for="newslett">Subscribe to our newsletter</label>
									</div>
								</div>
							</div>
						</div>
						...
						<!-- Tab Four -->
							...
							<div class="col-md-12">
								...
								<div class="checkbox-items3">
									<div class="ci-item3">
										<input type="checkbox" name="a" id="ta">
										<label for="ta">Terms and conditions</label>
									</div>
									<div class="ci-item3">
										<input type="checkbox" name="b" id="newacco">
										<label for="newacco">Create an account</label>
										<input type="password" placeholder="password">
									</div>
									<div class="ci-item3">
										<input type="checkbox" name="c" id="newslet">
										<label for="newslet">Subscribe to our newsletter</label>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="order-card">
							...
							<?php
		                               ...
		                               include('C:/xampp/htdocs/hatly/Connection/connection.php');		
                                         ...
                                         foreach($rows as $pat)
										 {
											 ...
											 //$total += $pat["price"];
											    ...
											    echo '<tr><td>' . $pat["name"]  . '</td><td>' . "$" . $pat["price"]  . '</td></tr>';
						       ...
						       ?>
											...
											<tr>
												<td>SubTotal</td>
												<td><?php if($tota > 0){ echo "$" . $tota; }else{echo "$0.00";}  ?></td>
											</tr>
						       ...
						       ?>
								...
								<div class="payment-method">
									<div class="pm-item" data-class=".tab-one">
										<input type="radio" name="pm" id="one">
										<label for="one">Paypal</label>
									</div>
									<div class="pm-item" data-class=".tab-two">
										<input type="radio" name="pm" id="two">
										<label for="two">Cash on delievery</label>
									</div>
									<div class="pm-item" data-class=".tab-three">
										<input type="radio" name="pm" id="three">
										<label for="three">Credit card</label>
									</div>
									<div class="pm-item selected" data-class=".tab-four">
										<input type="radio" name="pm" id="four" checked>
										<label for="four">Direct bank transfer</label>
									</div>
								</div>
							</div>
							<a href="order-complete.php" class="site-btn btn-full btn btn-primary">Place Order</a>
						</div>
					</div>
				</div>
			</form>
